...
![PR EOS Equation](/static/img/blogs/eos-modeling-with-neural-nets/PR_EOS_Equation.jpg)
...
![Compute Time Summary](/static/img/blogs/eos-modeling-with-neural-nets/Compute_Times.jpg)
...
![example liquid output](/static/img/blogs/eos-modeling-with-neural-nets/Liq_out_Comparison.png)
![example gas output](/static/img/blogs/eos-modeling-with-neural-nets/Gas_out_Comparison.png)

**Mean Absolute Error (MAE) of Every Component For Each Model**  
*NN = Neural Network, XGB = XGBoost, RR = Rachford Rice*  
![MAE comparison](/static/img/blogs/eos-modeling-with-neural-nets/MAE_output_df.jpg)
...
![generated data](/static/img/blogs/eos-modeling-with-neural-nets/composition_generated_stacked_1.png) 
...
![Shrinkage NN](/static/img/blogs/eos-modeling-with-neural-nets/Shrink_NN_Comparison.png) 

![Shrinkage XGB](/static/img/blogs/eos-modeling-with-neural-nets/Shrink_XGB_Comparison.png)   
![GOR NN](/static/img/blogs/eos-modeling-with-neural-nets/GOR_NN_Comparison.png)   
![GOR XGB](/static/img/blogs/eos-modeling-with-neural-nets/GOR_XGB_Comparison.png)
